<template>
  <header>
    <div class="header-inner">
      ...
      <button class="theme-toggle" @click="handleToggle" :title="isDark ? '切换日间模式' : '切换夜间模式'">
        <span class="toggle-icon" :class="{ rotating: isAnimating }">
...
.toggle-icon.rotating {
  animation: icon-spin 0.4s ease-in-out;
}
</style>
